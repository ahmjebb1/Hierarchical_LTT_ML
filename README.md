...
# data
Raw LTT data is processed using the updated [Lotti App](https://github.com/bubblecontrol/lotti_app). Raw GT data from the [Wytham Wood dataset](https://nilomr.github.io/great-tit-hits/, hosted at OSF: https://osf.io/n8ac9/files/osfstorage.

- `scripts/???.py` - script to convert the raw GT data to the 300 sample pickle format (the same as LTTs)
